...
Model.py
------------------------
Train a 1D Convolutional Neural Network (Conv1D) to classify EEG windows
as normal or abnormal.

This script:
1. Loads preprocessed EEG window data from `.npy` files.
2. Standardizes the signals using a `StandardScaler`.
3. Builds and trains a Conv1D-based classification model.
4. Saves the scaler and trained model for reuse.

Before running:
---------------
- Place your EEG window data in the `data/` folder:
    data/
        x_train.npy
        x_test.npy
        y_train.npy
